// 获取本周、本月、本年的开始结束日期，精确到年月日
// 此外还有上月的开始结束日期、本季度的开始结束日期
...
module.exports = {  //向外提供需要调用的方法
  ...
  getWeekStartDate: getWeekStartDate, //本周
  getWeekEndDate: getWeekEndDate,
  getMonthStartDate: getMonthStartDate, //本月
  getMonthEndDate: getMonthEndDate,
  getQuarterStartDate: getQuarterStartDate, //本季
  getQuarterEndDate: getQuarterEndDate,
  getYearStartDate: getYearStartDate, //本年
